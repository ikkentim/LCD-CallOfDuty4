...
namespace CoD4
{
    internal class Program
    {
        ...
        private static void Query()
        {
            ...
            _mapLabel.Text = _currentResponse.Variables["mapname"].Length > 3 ? _currentResponse.Variables["mapname"].Substring(3) : "-";
        ...
        private static void UpdatePlayerInfo()
        {
            ...
            {
                _player1Label.Text = _currentResponse.Players[_playerIndex].Name;
            ...
            {
                _player2Label.Text =_currentResponse.Players[_playerIndex + 1].Name;
